...
*/
func ProveGeneric(secret *big.Int, params *bprp, seed *big.Int) (ProofBPRP, error) {
	var proof ProofBPRP
	...
	var err1 error
	proof.P1, err1 = Prove(xb, params.BP1, seed.Int64())
	if err1 != nil {
		return proof, err1
	}
	...
	var err2 error
	proof.P2, err2 = Prove(xa, params.BP2, seed.Int64())
	if err2 != nil {
		return proof, err2
	}
